...
Here we specify the sample annotation that will be included in the statistical
model. These variables should agree with the variables defined in the metadata
text file (see 
[06-Setting up the DGE analysis](https://github.com/csoneson/rnaseqworkflow/wiki/06-Setting-up-the-DGE-analysis)).
