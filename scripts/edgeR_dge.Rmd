...
Now we perform genewise tests for every contrast defined above, and we save the results of every contrast.
...
And we export the results for every gene included in the analyses (including those filtered out), into a `SummarizedExperiment` which we can feed in `iSEE`, and perform more exploratory and visual analysis.
